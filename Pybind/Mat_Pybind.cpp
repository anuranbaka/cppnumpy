...
PYBIND11_MODULE (Mat_Pybind, m){
    py::class_<Mat<double>>(m, "Mat")
        ...
        .def("__iadd__", py::overload_cast<const double&>(&Mat<double>::operator+=))
        ...
        .def("__isub__", py::overload_cast<const double&>(&Mat<double>::operator-=))
        ...
        .def("__imul__", py::overload_cast<const double&>(&Mat<double>::operator*=))
        ...
        .def("__itruediv__", py::overload_cast<const double&>(&Mat<double>::operator/=))
